...
<div class="card-footer"><a href="<?= base_url('petugas') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a> <a href="<?= base_url("petugas/edit/{$data['id']}") ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a></div>
</div>
<?= $this->endSection() ?>
