      ...
      <tbody>
        ...
        <tr>
          ...
          <td nowrap>
            ...
            <button class="btn btn-sm btn-danger btn-hapus" data-url="<?= base_url("skpd/{$row['id']}") ?>" data-nama="<?= esc($row['nama_skpd']) ?>" title="Nonaktifkan"><i class="fas fa-trash"></i></button>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
