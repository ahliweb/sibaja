      ...
      <tbody>
        ...
        <tr>
          ...
          <td nowrap>
            ...
            <a href="<?= base_url("skpd/edit/{$row['id']}") ?>" class="btn btn-sm btn-warning" title="Edit"><i class="fas fa-edit"></i></a>
            <button class="btn btn-sm btn-danger btn-hapus" data-url="<?= base_url("skpd/delete/{$row['id']}") ?>" data-nama="<?= esc($row['nama_skpd']) ?>" title="Nonaktifkan"><i class="fas fa-trash"></i></button>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
