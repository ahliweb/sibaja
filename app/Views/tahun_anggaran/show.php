...
<div class="card-footer"><a href="<?= base_url('tahun-anggaran') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a> <a href="<?= base_url("tahun-anggaran/{$data['id']}/edit") ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a></div>
</div>
<?= $this->endSection() ?>
