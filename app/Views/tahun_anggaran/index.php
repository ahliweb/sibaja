...
<div class="card card-primary card-outline">
  <div class="card-header"><h3 class="card-title"><?= $title ?></h3>
    <div class="card-tools"><a href="<?= base_url('tahun-anggaran/create') ?>" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Tambah</a></div>
  </div>
  <div class="card-body table-responsive">
    <table class="table table-bordered table-striped table-hover dataTable" id="tabelData">
      <thead class="table-light"><tr><th>No</th><th>Tahun</th><th>Status</th><th>Aksi</th></tr></thead>
      <tbody>
        ...
        <tr><td><?= $no++ ?></td><td><?= esc($row['tahun']) ?></td>
          ...
          <td><a href="<?= base_url("tahun-anggaran/edit/{$row['id']}") ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
            <button class="btn btn-sm btn-danger btn-hapus" data-url="<?= base_url("tahun-anggaran/{$row['id']}") ?>" data-nama="<?= esc($row['tahun']) ?>"><i class="fas fa-trash"></i></button></td>
        </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
