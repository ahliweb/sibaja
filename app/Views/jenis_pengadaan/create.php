...
<div class="card card-primary">
  ...
  <form action="<?= base_url($isEdit ? "jenis-pengadaan/{$data['id']}/update" : 'jenis-pengadaan/store') ?>" method="post">
    <?= csrf_field() ?>
    <div class="card-body">
    ...
    <div class="card-footer"><button type="submit" class="btn btn-success"><i class="fas fa-save"></i> Simpan</button> <a href="<?= base_url('jenis-pengadaan') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Batal</a></div>
  </form>
</div>
<?= $this->endSection() ?>
